...
type UserServiceClient interface {
	...
	UpdateById(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateByIdResponse, error)
}
...
func (c *userServiceClient) UpdateById(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateByIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	UpdateById(context.Context, *UpdateRequest) (*UpdateByIdResponse, error)
...
func (UnimplementedUserServiceServer) UpdateById(context.Context, *UpdateRequest) (*UpdateByIdResponse, error) {
...
func _UserService_UpdateById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UpdateById(ctx, req.(*UpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
