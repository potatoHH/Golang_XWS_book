...
// CancleLike mocks base method.
func (m *MockInteractiveService) CancleLike(ctx context.Context, biz string, bizId, uid int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CancleLike", ctx, biz, bizId, uid)
	ret0, _ := ret[0].(error)
	return ret0
}

// CancleLike indicates an expected call of CancleLike.
func (mr *MockInteractiveServiceMockRecorder) CancleLike(ctx, biz, bizId, uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CancleLike", reflect.TypeOf((*MockInteractiveService)(nil).CancleLike), ctx, biz, bizId, uid)
}
