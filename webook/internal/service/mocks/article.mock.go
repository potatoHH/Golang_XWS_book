...
func (mr *MockArticleServiceMockRecorder) GetById(ctx, id, uid interface{}) *gomock.Call {
...
func (mr *MockArticleServiceMockRecorder) List(ctx, uid, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockArticleService) ListPub(ctx context.Context, offset, limt int) ([]domain.Article, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListPub", ctx, offset, limt)
	ret0, _ := ret[0].([]domain.Article)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockArticleServiceMockRecorder) ListPub(ctx, offset, limt interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListPub", reflect.TypeOf((*MockArticleService)(nil).ListPub), ctx, offset, limt)
}
